...
function Review1() {
  ...
  return (
   <section className='my-16 font-Montserrat'>
    ...
    <div className="p-6 bg-accent rounded-md text-secondary ">
     <h1 className="text-center text-2xl font-bold mb-2 text-secondary font-poppins">Enter Review: </h1>
  ...
  method="POST" className=''>
        ...
        <button
          ...
          className="max-w-[180px] rounded px-4 py-3 text-primary font-bold bg-secondary"
        >
          Submit Review
        </button>
      </form>
