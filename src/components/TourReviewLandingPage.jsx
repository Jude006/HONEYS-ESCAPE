...
function TourReviewLandingPage() {
  ...
  <div>
    <Navbar />
      <div className='relative w-full md:h-[70vh] h-[80vh] overflow-hidden font-mont'>
      {/* Background Image */}
      <div
      ...
      >
        <div className='max-w-3xl mx-auto px-4'>
          ...
          <p className='text-[16px] md:text-lg mb-6 font-Montserrat'>
         ...
         <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className='py-3 px-6 bg-primary font-poppins text-white rounded-lg shadow-md hover:bg-opacity-50 transition duration-300'
          >
            Contact Us
          </motion.button>
         </Link>
