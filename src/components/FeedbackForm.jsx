      ...
      <section className="container font-mont mx-auto py-10 ">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center mb-6 gap-6">
          ...
          <div className="bg-secondary rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-center mb-4 font-poppins" >We Value Your Feedback</h2>
            <form  action="https://formspree.io/f/mrbzwqoj"
  method="POST" className="space-y-4 font-Montserrat">
              <div>
                <input
                  type="text"
                  name="name"
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center bg-accent text-white py-2 rounded-lg hover:bg-secondary-dark transition"
              >
                Submit Feedback
              </button>
            </form>
