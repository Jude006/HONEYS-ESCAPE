...
import TourReviews from '../Data/TourReviews.json';
  ...
  return (
    <section className="font-Montserrat">
      ...
      <div className="text-center my-10 font-mont">
        ...
        <p className="text-lg text-tertiary font-Montserrat md:max-w-[80%] mx-auto">
      ...
      >
        {TourReviews.map((item, index) => (
          <SwiperSlide key={index} className="items-center flex">
            <div className="flex flex-col gap-3 px-6 py-4 bg-primary my-10 text-secondary rounded">
              {/* Testimonial */}
              <div>
