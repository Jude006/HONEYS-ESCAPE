...
function SearchAndFilter() {
  ...
  return (
    <section className="font-mont py-10 bg-secondary min-h-screen transition-all duration-500 font-Montserrat">
      <div className="container mx-auto lg:px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-2 text-primary font-poppins">
            Explore Your Next Trip
          </h2>
          <p className="text-lg text-primary font-Montserrat">
