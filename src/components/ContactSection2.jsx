...
function ContactSection2() {
  return (
    ...
    className='w-full object-cover font-mont bg-fixed bg-cover md:py-10 py-10  md:my-16 my-10 font-Montserratc:\Users\user\Desktop\travel-smart\public\images\test1.png c:\Users\user\Desktop\travel-smart\public\images\test2.png c:\Users\user\Desktop\travel-smart\public\images\test3.png'>
    <section className='grid md:grid-cols-2 gap-10 grid-cols-1 text-secondary'>
    <div className='flex flex-col justify-center'>
        ...
        <h2 className='flex gap-3 items-center mt-6 font-normal font-poppins'>
    ...
    <div>
    <div className="w-full h-auto  bg-secondary mb-4 flex justify-center items-center">
          ...
          {reviews.map((review, index) => (
            <SwiperSlide key={index} className="flex justify-center items-center">
              <div className="bg-secondary shadow-lg rounded-lg p-8 text-center">
                ...
                />
                <h3 className="text-2xl font-semibold text-primary">{review.name}</h3>
